(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue"), require("moment"), require("moment-jalaali")) : typeof define === "function" && define.amd ? define([
		"exports",
		"vue",
		"moment",
		"moment-jalaali"
	], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.Vue3PersianDatetimePicker = {}, global.Vue, global.moment, global.moment));
})(this, function(exports, vue, moment, moment_jalaali) {
	...
	moment_jalaali = __toESM(moment_jalaali, 1);
	...
	function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", {
			...
			style: (0, vue.normalizeStyle)({ transform: `rotate(${$options.rotation}deg)` })
	...
	function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("svg", {
			...
			fill: $props.fill,
			viewBox: "0 0 512 512"
		}, [..._cache[0] || (_cache[0] = [(0, vue.createElementVNode)("path", { d: "M256 8C119 8 8 119 8 256S119 504 256 504 504 393 504 256 393 8 256 8zM313.1 358.1L224.9 294C221.8 291.7 220\n      288.1 220 284.3V116C220 109.4 225.4 104 232 104H280C286.6 104 292 109.4 292 116V253.7L355.5 299.9C360.9 303.8\n      362 311.3 358.1 316.7L329.9 355.5C326 360.8 318.5 362 313.1 358.1z" }, null, -1)])], 8, _hoisted_1$7);
	}
	...
	function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("ul", null, [(0, vue.createElementVNode)("li", {
			onClick: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("change", $options.activeItem)),
			textContent: (0, vue.toDisplayString)($options.label)
		}, null, 8, _hoisted_1$5)]);
	}
	...
	function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
		...
		}, [(0, vue.renderSlot)(_ctx.$slots, "default")], 32);
	}
	...
	*/
	...
	function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
		const _component_arrow = (0, vue.resolveComponent)("arrow");
		const _component_btn = (0, vue.resolveComponent)("btn");
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", { class: (0, vue.normalizeClass)(["vpd-time-column", $data.classFastCounter]) }, [
			(0, vue.createVNode)(_component_btn, {
				class: "vpd-up-arrow-btn",
				onUpdate: _cache[0] || (_cache[0] = ($event) => $options.update(1)),
				onFastUpdate: $options.fastUpdateCounter
			}, {
				default: (0, vue.withCtx)(() => [(0, vue.createVNode)(_component_arrow, {
					width: "20",
					direction: "up"
				})]),
				_: 1
			...
			(0, vue.createElementVNode)("div", {
				class: (0, vue.normalizeClass)(["vpd-counter", [$data.directionClass, { "vpd-is-focused": $data.isInputFocused }]]),
				onMousewheel: _cache[8] || (_cache[8] = (0, vue.withModifiers)(($event) => $options.wheelUpdate($event), ["stop", "prevent"])),
				"on:DOMMouseScroll": _cache[9] || (_cache[9] = (0, vue.withModifiers)(($event) => $options.wheelUpdate($event), ["stop", "prevent"]))
				...
				class: (0, vue.normalizeClass)({ "is-empty": !$data.inputValue.length }),
				...
				onKeydown: [
					_cache[5] || (_cache[5] = (0, vue.withKeys)((0, vue.withModifiers)(($event) => $options.update(1), ["prevent"]), ["up"])),
					_cache[6] || (_cache[6] = (0, vue.withKeys)((0, vue.withModifiers)(($event) => $options.update(-1), ["prevent"]), ["down"])),
					_cache[7] || (_cache[7] = (0, vue.withKeys)((0, vue.withModifiers)((...args) => $options.onInputSubmit && $options.onInputSubmit(...args), ["prevent"]), ["enter"]))
				]
			}, null, 42, _hoisted_1$4), [[vue.vModelText, $data.inputValue]]), ((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(_ctx.modelValue.toString().split(""), (item, i) => {
				return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
					key: `h__${i}`,
					class: "vpd-counter-item"
				}, { ref_for: true }, $props.attributes), [(0, vue.createVNode)(vue.Transition, { name: "slideY" }, {
					default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
						key: `${item}__${i}_h`,
						style: (0, vue.normalizeStyle)({ transition: "all " + $data.transitionSpeed + "ms ease-in-out" }),
						textContent: (0, vue.toDisplayString)($props.formatter(item))
	...
	function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
		const _component_time_column = (0, vue.resolveComponent)("time-column");
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", { class: (0, vue.normalizeClass)(["vpd-addon-list vpd-time", { "vpd-disabled": $props.isDisableTime }]) }, [(0, vue.createElementVNode)("div", _hoisted_1$3, [(0, vue.createVNode)(_component_time_column, {
			ref: "hour",
			...
			"formatter",
			"onFilled"
		]), (0, vue.createVNode)(_component_time_column, {
			ref: "minute",
	...
	function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
			class: (0, vue.normalizeClass)(["vpd-column", { "vpd-is-mounted": $data.isMounted }]),
			onMousewheel: _cache[0] || (_cache[0] = (0, vue.withModifiers)(() => {}, ["stop"]))
		}, [$props.label ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
			key: 0,
			class: "vpd-column-header",
			textContent: (0, vue.toDisplayString)($props.label)
		}, null, 8, _hoisted_1$2)) : (0, vue.createCommentVNode)("", true), (0, vue.createElementVNode)("div", _hoisted_2$2, [(0, vue.renderSlot)(_ctx.$slots, "default")], 512)], 34);
	}
	//#endregion
	...
	function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
		const _component_locale_change = (0, vue.resolveComponent)("locale-change");
		const _component_simple_mode_column = (0, vue.resolveComponent)("simple-mode-column");
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_1$1, [$options.showHeader ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
			key: 0,
			class: "vpd-header",
			style: (0, vue.normalizeStyle)({ "background-color": $props.color })
		}, [(0, vue.createElementVNode)("div", null, [(0, vue.renderSlot)(_ctx.$slots, "header-date", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
			vm: $data.vm,
			formattedDate: $props.formattedDate
		})), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($props.convertToLocaleNumber($props.formattedDate)), 1)])]), $props.locales.length > 1 ? (0, vue.renderSlot)(_ctx.$slots, "locales", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
			vm: $data.vm,
			locales: $props.locales,
			setLocale: $props.setLocale
		})), () => [(0, vue.createVNode)(_component_locale_change, {
			...
			"locales",
			"onChange"
		])], void 0, 0) : (0, vue.createCommentVNode)("", true)], 4)) : (0, vue.createCommentVNode)("", true), (0, vue.createElementVNode)("div", {
			class: "vpd-simple-content",
			onMouseleave: _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:hovered-item", null))
		}, [
			$props.hasStep("y") ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_simple_mode_column, {
				key: 0,
				label: $props.lang.year,
				value: $options.selectedYear,
				locale: $props.core.locale.name
			}, {
				default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($props.years, (year, yi) => {
					return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ key: yi }, { ref_for: true }, year.attributes, {
						class: [
							"vpd-addon-list-item",
					...
					}), [(0, vue.renderSlot)(_ctx.$slots, "year-item", (0, vue.mergeProps)({ ref_for: true }, {
						vm: $data.vm,
						year,
						color: $props.color
					}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($props.convertToLocaleNumber(year.xFormat("jYYYY"))), 1)])], 16, _hoisted_2$1);
				}), 128))]),
				_: 3
			}, 8, [
				"label",
			...
			$props.hasStep("m") ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_simple_mode_column, {
				key: 1,
				label: $props.lang.month,
				value: $options.selectedMonth,
				locale: $props.core.locale.name
			}, {
				default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($props.months, (month, mi) => {
					return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ key: mi }, { ref_for: true }, month.attributes, {
						class: [
							"vpd-addon-list-item",
					...
					}), [(0, vue.renderSlot)(_ctx.$slots, "month-item", (0, vue.mergeProps)({ ref_for: true }, {
						vm: $data.vm,
						monthItem: month,
						color: $props.color
					}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)(month.xFormat("jMMMM")), 1)])], 16, _hoisted_3$1);
				}), 128))]),
				_: 3
			}, 8, [
				"label",
			...
			$props.hasStep("d") ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_simple_mode_column, {
				key: 2,
				label: $props.lang.day,
				value: $options.selectedDay,
				locale: $props.core.locale.name
			}, {
				default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.days, (day, di) => {
					return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
						key: di,
						class: [
							"vpd-addon-list-item",
					...
					}), [day.date != null ? (0, vue.renderSlot)(_ctx.$slots, "day-item", (0, vue.mergeProps)({ ref_for: true }, {
						vm: $data.vm,
						day,
						color: $props.color
					}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($props.convertToLocaleNumber(day.formatted)), 1)], void 0, 0) : (0, vue.createCommentVNode)("", true)], 16, _hoisted_4$1);
				}), 128))]),
				_: 3
			}, 8, [
				"label",
	...
	moment_jalaali.default.updateLocale("en", { weekdaysMin: "S_M_T_W_T_F_S".split("_") });
	moment_jalaali.default.updateLocale("fa", moment_locale_fa_default);
	moment_jalaali.default.loadPersian({ dialect: "persian-modern" });
	moment_jalaali.default.daysInMonth = function(year, month) {
		return (0, moment_jalaali.default)({
			year,
			month
		}).daysInMonth();
	};
	...
	var Core = function(defaultLocaleName, defaultOptions) {
		"use strict";
		const Instance = {
			moment: moment_jalaali.default,
			momentBase: moment.default,
			locale: {
				name: "fa",
				config: {}
			},
		...
		Instance.changeLocale = function changeLocale(localeName = "fa", options = {}) {
			...
			xDaysInMonth = moment_jalaali.default[methods.daysInMonth];
			function addMethods(date) {
				...
				date.xYear = moment_jalaali.default.fn[methods.year];
				date.xMonth = moment_jalaali.default.fn[methods.month];
				date.xDate = moment_jalaali.default.fn[methods.date];
			...
			this.moment = function() {
				let date = moment_jalaali.default.apply(null, arguments);
	...
	function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
		const _component_time_icon = (0, vue.resolveComponent)("time-icon");
		const _component_calendar_icon = (0, vue.resolveComponent)("calendar-icon");
		const _component_locale_change = (0, vue.resolveComponent)("locale-change");
		const _component_simple_mode = (0, vue.resolveComponent)("simple-mode");
		const _component_arrow = (0, vue.resolveComponent)("arrow");
		const _component_time_section = (0, vue.resolveComponent)("time-section");
		return (0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
			class: (0, vue.normalizeClass)(["vpd-main", { "vpd-is-popover": $options.isPopover }]),
			"data-type": $props.type,
			"data-placement": $data.popoverPlace,
			"data-locale": $data.localeData.name,
			"data-locale-dir": $data.localeData.config.dir
		}, [!$options.customInputElement ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
			key: 0,
			ref: "inputGroup",
			class: (0, vue.normalizeClass)(["vpd-input-group", { "vpd-disabled": $props.disabled }])
		}, [
			(0, vue.createElementVNode)("label", {
				for: $options.id,
				class: "vpd-icon-btn",
				style: (0, vue.normalizeStyle)({ "background-color": $props.color }),
				onClick: _cache[0] || (_cache[0] = (0, vue.withModifiers)(($event) => $data.visible = !$data.visible, ["prevent", "stop"]))
			}, [(0, vue.renderSlot)(_ctx.$slots, "label", {}, () => [$props.type === "time" ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_time_icon, {
				key: 0,
				width: "16px",
				height: "16px"
			})) : ((0, vue.openBlock)(), (0, vue.createBlock)(_component_calendar_icon, {
				key: 1,
				width: "16px",
				height: "16px"
				...
				key: 2,
				textContent: (0, vue.toDisplayString)($props.label)
			}, null, 8, _hoisted_3)) : (0, vue.createCommentVNode)("", true)])], 12, _hoisted_2),
			(0, vue.createElementVNode)("input", (0, vue.mergeProps)({
				...
				onKeydown: _cache[3] || (_cache[3] = (0, vue.withKeys)((...args) => $options.setOutput && $options.setOutput(...args), ["enter"]))
			}), null, 16, _hoisted_4),
			$props.altName ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("input", {
				key: 0,
				type: "hidden",
				name: $props.altName,
				value: $options.altFormatted
			}, null, 8, _hoisted_5)) : (0, vue.createCommentVNode)("", true),
			$props.clearable && !$props.disabled && $options.displayValue ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("i", {
				key: 1,
				class: "vpd-clear-btn",
				onClick: _cache[4] || (_cache[4] = (...args) => $options.clearValue && $options.clearValue(...args))
			}, [(0, vue.renderSlot)(_ctx.$slots, "clear-btn", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({ vm: $options.vm })), () => [_cache[17] || (_cache[17] = (0, vue.createTextVNode)("x", -1))])])) : (0, vue.createCommentVNode)("", true)
		], 2)) : $props.altName ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("input", {
			key: 1,
			type: "hidden",
			name: $props.altName,
			value: $options.altFormatted
		}, null, 8, _hoisted_6)) : (0, vue.createCommentVNode)("", true), (0, vue.createVNode)(vue.Transition, { name: $options.isPopover ? "" : "vpd-fade-scale" }, {
			default: (0, vue.withCtx)(() => [$data.visible ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				key: 0,
				ref: "picker",
				...
				"data-type": $props.type,
				onClick: _cache[16] || (_cache[16] = (0, vue.withModifiers)((...args) => $options.wrapperClick && $options.wrapperClick(...args), ["self"]))
			}, [(0, vue.createElementVNode)("div", _hoisted_8, [(0, vue.createElementVNode)("div", _hoisted_9, [!$props.simple ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
				key: 0,
				class: "vpd-header",
				style: (0, vue.normalizeStyle)({ "background-color": $props.color })
			}, [
				[
					...
					"datetime",
					"year-month"
				].indexOf($props.type) !== -1 ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
					key: 0,
					class: (0, vue.normalizeClass)(["vpd-year-label", $data.directionClass]),
					onClick: _cache[5] || (_cache[5] = ($event) => $options.goStep("y"))
				}, [(0, vue.createVNode)(vue.Transition, { name: "slideY" }, {
					default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)("span", { key: $options.selectedDate.xYear() }, [(0, vue.renderSlot)(_ctx.$slots, "header-year", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
						vm: $options.vm,
						selectedDate: $options.selectedDate
					})), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.convertToLocaleNumber($options.selectedDate.xYear())), 1)])]))]),
					_: 3
				})], 2)) : (0, vue.createCommentVNode)("", true),
				$props.type !== "year-month" ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
					key: 1,
					class: (0, vue.normalizeClass)(["vpd-date", $data.directionClass])
				}, [(0, vue.createVNode)(vue.Transition, { name: "slideY" }, {
					default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)("span", { key: $options.formattedDate }, [(0, vue.renderSlot)(_ctx.$slots, "header-date", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
						vm: $options.vm,
						formattedDate: $options.formattedDate
					})), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.convertToLocaleNumber($options.formattedDate)), 1)])]))]),
					_: 3
				})], 2)) : (0, vue.createCommentVNode)("", true),
				$data.locales.length > 1 ? (0, vue.renderSlot)(_ctx.$slots, "locales", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
					vm: $options.vm,
					...
					"locales",
					"onChange"
				])], void 0, 2) : (0, vue.createCommentVNode)("", true)
			], 4)) : (0, vue.createCommentVNode)("", true), (0, vue.createElementVNode)("div", _hoisted_10, [
				$props.simple ? ((0, vue.openBlock)(), (0, vue.createBlock)(_component_simple_mode, {
					key: 0,
					lang: $options.lang,
					core: $data.core,
					range: $props.range,
					...
					"header-date": (0, vue.withCtx)((slotData) => [(0, vue.renderSlot)(_ctx.$slots, "header-date", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(slotData)))]),
					locales: (0, vue.withCtx)((slotData) => [(0, vue.renderSlot)(_ctx.$slots, "locales", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(slotData)))]),
					"year-item": (0, vue.withCtx)((slotData) => [(0, vue.renderSlot)(_ctx.$slots, "year-item", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(slotData)))]),
					"month-item": (0, vue.withCtx)((slotData) => [(0, vue.renderSlot)(_ctx.$slots, "month-item", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(slotData)))]),
					"day-item": (0, vue.withCtx)((slotData) => [(0, vue.renderSlot)(_ctx.$slots, "day-item", (0, vue.normalizeProps)((0, vue.guardReactiveProps)(slotData)))]),
					_: 3
				}, 8, [
					"lang",
					"core",
					...
					"onSelectMonth",
					"onSelectDay"
				])) : ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 1 }, [
					$options.hasStep("d") ? ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 0 }, [(0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)(["vpd-controls", $data.directionClassDate]) }, [
						...
						}, [(0, vue.renderSlot)(_ctx.$slots, "next-month", {}, () => [(0, vue.createVNode)(_component_arrow, {
							width: "10",
							fill: "#000",
							direction: "right",
						...
						}, [(0, vue.renderSlot)(_ctx.$slots, "prev-month", {}, () => [(0, vue.createVNode)(_component_arrow, {
							width: "10",
							fill: "#000",
							direction: "left",
							style: { "vertical-align": "middle" }
						})])], 8, _hoisted_12),
						(0, vue.createVNode)(vue.Transition, { name: "slideX" }, {
							default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
							...
							}, [(0, vue.renderSlot)(_ctx.$slots, "month-name", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
								vm: $options.vm,
								date: $data.date,
								color: $props.color
								...
								textContent: (0, vue.toDisplayString)($options.convertToLocaleNumber($data.date.xFormat("jMMMM jYYYY")))
							}, null, 12, _hoisted_13)])]))]),
							_: 3
						})
					], 2), (0, vue.createElementVNode)("div", { class: (0, vue.normalizeClass)(["vpd-clearfix", ["vpd-month", $data.directionClassDate]]) }, [(0, vue.createElementVNode)("div", _hoisted_14, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.weekDays, (day, i) => {
						return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
							key: `${i}-${day}`,
							class: "vpd-weekday"
						}, [(0, vue.renderSlot)(_ctx.$slots, "weekday", (0, vue.mergeProps)({ ref_for: true }, {
							vm: $options.vm,
							day
						}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)(day), 1)])]);
					}), 128))]), (0, vue.createElementVNode)("div", {
						class: "vpd-days",
						style: (0, vue.normalizeStyle)({ height: $options.month.length * 40 + "px" }),
						onMouseleave: _cache[9] || (_cache[9] = ($event) => $data.hoveredItem = null)
					}, [(0, vue.createVNode)(vue.Transition, {
						name: "slideX",
						class: (0, vue.normalizeClass)($data.directionClassDate)
					}, {
						default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)("div", { key: $data.date.xMonth() }, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.monthDays, (m, mi) => {
							return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
								key: mi,
								class: "vpd-clearfix"
							}, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(m, (day, di) => {
								return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({
									key: di,
									class: [
										"vpd-day",
									...
									style: (0, vue.normalizeStyle)({ "background-color": $props.color })
								}, null, 4), (0, vue.createElementVNode)("span", {
									class: "vpd-day-text",
									textContent: (0, vue.toDisplayString)($options.convertToLocaleNumber(day.formatted))
								}, null, 8, _hoisted_16)], void 0, 0) : (0, vue.createCommentVNode)("", true)], 16, _hoisted_15);
							}), 128))]);
						}), 128))]))]),
						_: 3
					}, 8, ["class"])], 36)], 2)], 64)) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_17)),
					(0, vue.createVNode)(vue.Transition, { name: "fade" }, {
						default: (0, vue.withCtx)(() => [$options.hasStep("y") ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
							key: 0,
							ref: "year",
							class: (0, vue.normalizeClass)(["vpd-addon-list", { "vpd-can-close": $data.steps.length > 1 }])
						}, [(0, vue.createElementVNode)("div", _hoisted_18, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.years, (year, yi) => {
							return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ key: yi }, { ref_for: true }, year.attributes, {
								class: [
									"vpd-addon-list-item",
									{ "vpd-selected": year.selected },
								...
								year,
								color: $props.color
							}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)($options.convertToLocaleNumber(year.xFormat("jYYYY"))), 1)])], 16, _hoisted_19);
						}), 128))])], 2)), [[vue.vShow, $options.currentStep === "y"]]) : (0, vue.createCommentVNode)("", true)]),
						_: 3
					}),
					(0, vue.createVNode)(vue.Transition, { name: "fade" }, {
						default: (0, vue.withCtx)(() => [$options.hasStep("m") ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
							key: 0,
							ref: "month",
							class: (0, vue.normalizeClass)(["vpd-addon-list vpd-month-list", { "vpd-can-close": $data.steps.length > 1 }])
						}, [(0, vue.createElementVNode)("div", _hoisted_20, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)($options.months, (monthItem, mi) => {
							return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", (0, vue.mergeProps)({ key: mi }, { ref_for: true }, monthItem.attributes, {
								class: [
									"vpd-addon-list-item",
								...
								monthItem,
								color: $props.color
							}), () => [(0, vue.createTextVNode)((0, vue.toDisplayString)(monthItem.xFormat("jMMMM")), 1)])], 16, _hoisted_21);
						}), 128))])], 2)), [[vue.vShow, $options.currentStep === "m"]]) : (0, vue.createCommentVNode)("", true)]),
						_: 3
					}),
					(0, vue.createVNode)(vue.Transition, { name: "fade" }, {
						default: (0, vue.withCtx)(() => [$data.steps.length > 1 && $options.currentStep !== "d" && $options.hasStep("d") ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", {
							key: 0,
							class: "vpd-close-addon",
							onClick: _cache[10] || (_cache[10] = ($event) => $options.goStep("d"))
						}, [(0, vue.renderSlot)(_ctx.$slots, "close-btn", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({ vm: $options.vm })), () => [_cache[18] || (_cache[18] = (0, vue.createTextVNode)("x", -1))])])) : (0, vue.createCommentVNode)("", true)]),
						_: 3
					})
				], 64)),
				(0, vue.createVNode)(vue.Transition, { name: "fade" }, {
					default: (0, vue.withCtx)(() => [$options.hasStep("t") ? (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(_component_time_section, {
						key: 0,
						ref: "time",
						date: $data.date,
						...
						"selected-dates",
						"convert-to-locale-number"
					])), [[vue.vShow, $options.currentStep === "t"]]) : (0, vue.createCommentVNode)("", true)]),
					_: 1
				}),
				$props.autoSubmit && !$options.hasStep("t") ? ((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: 2 }, [!$props.simple ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("br", _hoisted_22)) : (0, vue.createCommentVNode)("", true)], 64)) : ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_23, [
					(0, vue.renderSlot)(_ctx.$slots, "submit-btn", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
						vm: $options.vm,
						...
						style: (0, vue.normalizeStyle)({ color: $props.color }),
						onClick: _cache[13] || (_cache[13] = (...args) => $options.submit && $options.submit(...args)),
						textContent: (0, vue.toDisplayString)($options.lang.submit)
					}, null, 12, _hoisted_24)]),
					!$props.inline ? (0, vue.renderSlot)(_ctx.$slots, "cancel-btn", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
						vm: $options.vm,
						color: $props.color,
						lang: $options.lang
					})), () => [(0, vue.createElementVNode)("button", {
						...
						textContent: (0, vue.toDisplayString)($options.lang.cancel)
					}, null, 12, _hoisted_25)], void 0, 0) : (0, vue.createCommentVNode)("", true),
					$props.showNowBtn && $options.canGoToday ? (0, vue.renderSlot)(_ctx.$slots, "now-btn", (0, vue.normalizeProps)((0, vue.guardReactiveProps)({
						vm: $options.vm,
						color: $props.color,
						...
						textContent: (0, vue.toDisplayString)($options.lang.now)
					}, null, 12, _hoisted_26)], void 0, 1) : (0, vue.createCommentVNode)("", true)
				]))
			])])], 512)], 10, _hoisted_7)) : (0, vue.createCommentVNode)("", true)]),
			_: 3
		}, 8, ["name"])], 10, _hoisted_1);
	}
	//#endregion
	exports.default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render]]);
});
